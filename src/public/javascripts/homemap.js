...
class LinkedList {
    ...
    push(pinObject) {
      // creates a new node
      // creates a new node
    var node = new PinNode(pinObject);
...
HomeMap.prototype.openPin = function(pinElement) {
  pinElement.show()
}
...
HomeMap.prototype.addPin = function(pin) {
  ...
  PinElement.prototype.onAdd = function() {
    ...
    if (!div) {
      ...
      var headerElement = this.createHeader();
      if(headerElement) div.appendChild(headerElement);

      //TAGS
      let tagContainer = this.createTagContainer();
      ...
      //descriptions
      let likeCommentContainer = this.createLikeCommentContainer();
      if(likeCommentContainer) div.appendChild(likeCommentContainer);

      //descriptions
      let descriptionContainer = this.createDescriptionContainer();
  ...
  PinElement.prototype.createTagContainer = function() {
    ...
    this.pin_.tags.forEach((tag) => {
      let tagElement = document.createElement('h4');
  ...
  PinElement.prototype.createLikeCommentContainer = function() {
    //Header
    let  likeCommentContainer = document.createElement("div");
  ...
  PinElement.prototype.createImageContainer = function() {
    ...
    let imageIndicators = document.createElement('ol');
